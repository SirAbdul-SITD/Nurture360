...
if ($resourceId <= 0) { redirect('./teacher_resources.php'); }

// Fetch resource with relations, ensuring ownership
$stmt = $pdo->prepare(
  "SELECT lr.*, 
...
$resource = $stmt->fetch();
if (!$resource) { redirect('./teacher_resources.php'); }
  ...
  <main class="main-content">
    <div class="page-header">
      ...
      <div class="header-actions">
        <a class="btn btn-primary" href="./teacher_resources.php"><i class="fas fa-arrow-left"></i> Back to My Resources</a>
        <?php if ($url): ?>
          <a class="btn btn-secondary" href="./teacher_resource_open.php?id=<?php echo (int)$resourceId; ?>" target="_blank"><i class="fas fa-link"></i> Open Link</a>
        <?php endif; ?>
        <?php if ($file): ?>
          <a class="btn btn-secondary" href="./teacher_resource_download.php?id=<?php echo (int)$resourceId; ?>" target="_blank"><i class="fas fa-download"></i> Download</a>
        <?php endif; ?>
      ...
      <div class="card-content">
        <div class="preview-box">
          ...
          <?php elseif ($isOffice && $file && $_absFileUrl): ?>
            <iframe src="https://docs.google.com/gview?embedded=1&url=<?php echo urlencode($_absFileUrl); ?>" style="width:100%; height:110vh; border:0;"></iframe>
          <?php elseif ($url): ?>
...
<?php
// Delete confirm modal (posts back to teacher_resources.php)
